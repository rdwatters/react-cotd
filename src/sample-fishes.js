...
module.exports = {
  fish10: {
    name: 'Blinky',
    image: 'http://vignette1.wikia.nocookie.net/simpsons/images/8/87/Blinky_Art.png/revision/latest?cb=20120326002951',
    desc: 'Everyone\'s favorite fish from Lake Springfield and the Simpsons.',
    price: 3000,
    status: 'available'
  },
  fish1: {
    ...
    desc: 'Everyones favorite white fish. We will cut it to the size you need and ship it right to your door.',
    price: 2724,
    status: 'available'
  },
  fish2: {
